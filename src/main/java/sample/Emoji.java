...
public class Emoji {
    private HashMap<String,ArrayList<String>> emojiList;
    ...
    public HashMap<String, ArrayList<String>> getEmojiList() {
        return emojiList;
    }

    private void addEmoji(HashMap<String,ArrayList<String>> emojiList){
        emojiList.put("ACTIVITY",new ArrayList<>(Arrays.asList(ACTIVITY)));
        emojiList.put("FLAGS",new ArrayList<>(Arrays.asList(FLAGS)));
        emojiList.put("FOOD_AND_DRINK",new ArrayList<>(Arrays.asList(FOOD_AND_DRINK)));
        emojiList.put("NATURE",new ArrayList<>(Arrays.asList(NATURE)));
        emojiList.put("OBJECTS",new ArrayList<>(Arrays.asList(OBJECTS)));
        emojiList.put("PEOPLE",new ArrayList<>(Arrays.asList(PEOPLE)));
        emojiList.put("SYMBOLS",new ArrayList<>(Arrays.asList(SYMBOLS)));
        emojiList.put("TRAVEL_AND_PLACES",new ArrayList<>(Arrays.asList(TRAVEL_AND_PLACES)));
    }

    public ArrayList<String> getEmoji_ACTIVITY(){
        return emojiList.get("ACTIVITY");
    }
    public ArrayList<String> getEmoji_FLAGS(){
        return emojiList.get("FLAGS");
    }
    public ArrayList<String> getEmoji_FOOD_AND_DRINK(){
        return emojiList.get("FOOD_AND_DRINK");
    }
    public ArrayList<String> getEmoji_NATURE(){
        return emojiList.get("NATURE");
    }
    public ArrayList<String> getEmoji_OBJECTS(){
        return emojiList.get("OBJECTS");
    }
    public ArrayList<String> getEmoji_PEOPLE(){
        return emojiList.get("PEOPLE");
    }
    public ArrayList<String> getEmoji_SYMBOLS(){
        return emojiList.get("SYMBOLS");
    }
    public ArrayList<String> getEmoji_TRAVEL_AND_PLACES(){
        return emojiList.get("TRAVEL_AND_PLACES");
    }


    private final String[] ACTIVITY = new String[] {
            "\ud83d\udc7e", // Alien Monster
    ...
    private final String[] FLAGS = new String[] {
    ...
    private final String[] FOOD_AND_DRINK = new String[] {
            "\ud83c\udf47", // Grapes
            "\ud83c\udf48", // Melon
            "\ud83c\udf49", // Watermelon
            "\ud83c\udf4a", // Tangerine
    ...
    private final String[] NATURE = new String[] {
            "\ud83d\ude48", // See-No-Evil Monkey
            "\ud83d\ude49", // Hear-No-Evil Monkey
    ...
    private final String[] TRAVEL_AND_PLACES = new String[] {
